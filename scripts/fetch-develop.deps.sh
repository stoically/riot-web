...
# this is just to pin the version until upstream support lands
# there's no custom code in that fork
dodep stoically matrix-js-sdk
...
# this fork has some changes, working on PRing them upstream
